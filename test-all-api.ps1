# ================================================================
# COMPREHENSIVE API ENDPOINT TESTING - SIMPLE VERSION
# ================================================================
...
function Test-Endpoint {
    ...
    try {
        ...
        if ($success) {
            ...
            Write-Host "[WARN] Expected $ExpectedStatus, got $statusCode" -ForegroundColor Yellow
            $script:failCount++
        }
...
Test-Endpoint -Method GET -Endpoint "/orders" `
    -Description "Get Orders (No Token)" `
    -ExpectedStatus 401
...
if ($schedulesResponse.Response.data) {
    Write-Host "[OK] Schedules has 'data' array" -ForegroundColor Green
    ...
    Write-Host "[INFO] No schedules data (table might be empty)" -ForegroundColor Cyan
}
...
if ($trackingResponse.Response.data) {
    Write-Host "[OK] Tracking has 'data' array" -ForegroundColor Green
    ...
    Write-Host "[INFO] No tracking data (table might be empty)" -ForegroundColor Cyan
}
...
if ($servicesResponse.Response.data) {
    Write-Host "[OK] Services has 'data' array" -ForegroundColor Green
    ...
    Write-Host "[INFO] No services data" -ForegroundColor Cyan
}
...
Test-Endpoint -Method GET -Endpoint "/schedules?limit=5" -Description "Pagination - Limit"
